...
async function testAPI() {
    ...
    console.log('   • Auth: http://localhost:4000/api/auth');
    console.log('   • Admin: http://localhost:4000/api/admin');
    console.log('   • Teacher: http://localhost:4000/api/teacher');
    console.log('   • Student: http://localhost:4000/api/student');
    console.log('   • Courses: http://localhost:4000/api/courses');
    console.log('   • Attendance: http://localhost:4000/api/attendance');
}
